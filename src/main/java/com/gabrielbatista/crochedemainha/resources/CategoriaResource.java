...
import com.gabrielbatista.crochedemainha.services.CategoriaService;
...
public class CategoriaResource {
	...
	public void insert(@Valid @RequestBody CategoriaDTO objDto) { // @valid para validar atraves da DTO
